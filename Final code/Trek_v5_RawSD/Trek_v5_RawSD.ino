...
void setup() {
  ...
  if (!SD.begin(SD_CS_PIN, SD_SCK_MHZ(200))) { // Use high-speed SPI
...
void loop() {
  ...
  sprintf(dataLine, "%d,%10.6f,%10.6f,%10.6f,%10.6f,%10.6f,%10.6f,%10.6f,%10.6f,%10.6f\n",
          Pnum, GyroX, GyroY, GyroZ, x, y, z, Magx, Magy, Magz);
  writeToBuffer(dataLine);
  Pnum += 1;
